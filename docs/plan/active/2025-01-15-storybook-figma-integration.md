...
**완료 기준**: 66개 스토리 모두 Figma URL + node-id 수집 완료, `scripts/figma-mapping.json` 파일 생성
...
**완료 기준**: registry.json에 66개 항목 모두 figma 메타데이터 추가, Registry 빌드 성공, JSON 파일에서 figma 필드 확인
