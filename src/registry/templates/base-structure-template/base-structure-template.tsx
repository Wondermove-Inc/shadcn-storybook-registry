  ...
  return (
    <SidebarProvider>
      <div className="bg-background flex h-screen flex-col">
        {/* 상단 헤더 - 최상단에 위치 */}
        <header className="bg-background border-border flex h-auto w-full shrink-0 items-center justify-between gap-2.5 border-b p-2">
          {/* 왼쪽 여백 */}
        ...
        {/* 메인 콘텐츠 영역 - 헤더 아래에 사이드바, 바디, AI 패널 배치 */}
        <div className="flex flex-1">
              ...
              <div className="flex h-full items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    왼쪽 사이드바에서 파일을 선택하면 내용을 확인할 수 있습니다.
                  </p>
                </div>
              </div>
            )}
          ...
          {/* AI 어시스턴트 패널 - 400px 고정 */}
          <aside className="bg-background border-border flex w-[400px] flex-col border-l">
