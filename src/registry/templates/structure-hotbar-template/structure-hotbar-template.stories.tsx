 ...
 * - Explorer, Skuber+ Observability 순서로 배치
 * - 활성/비활성 상태 시각적 표시
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `VS Code Activity Bar 스타일의 Hotbar 컴포넌트를 독립적으로 사용하는 템플릿입니다. Explorer와 Skuber+ Observability 아이콘이 배치되어 있으며, 전체 메인 그룹에서 단일 활성 상태로 관리됩니다.`,
      },
    },
  },
  decorators: [
 ...
 * ✨ 특징:
 * - 단일 메인 그룹: Explorer, Skuber+ Observability 순서로 배치
...
export const Default: Story = {
  render: () => {
    ...
    // 🎯 목적: 핫바 아이템 목록 - Explorer, Skuber+ Observability 2개만 표시
    const hotbarItems = [
      {
        id: "explorer",
        icon: Files,
...
export const Badge: Story = {
  render: () => {
    ...
    // 🎯 목적: Badge가 있는 메인 아이템 목록 - Explorer, Skuber+ Observability 2개만 표시
